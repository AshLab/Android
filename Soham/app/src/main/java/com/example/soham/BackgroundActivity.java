...
public class BackgroundActivity extends Service {
    ...
    private BroadcastReceiver screenButtonReceiver;
    ...
    private boolean rahamActive=false;
    ...
    public void onCreate()
    {
       ...
       // notificationManager.notify(1, notification);
        ...
        mpSoham = MediaPlayer.create(this, R.raw.raham);
    ...
    private void registerBroadcastReceiver()
    {
       ...
       screenButtonReceiver = new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                ...
                if(Intent.ACTION_SCREEN_OFF.equals(action)) {
                    ...
                    Log.d(TAG,"Screen Receiver : Screen Off");

                }

                else if(Intent.ACTION_SCREEN_ON.equals(action)) {
                    Log.d(TAG,"Screen Receiver : Screen On");
                    if (mediaPlayer != null) {
                        Log.d(TAG, "startRaHam: MediaPlayer not null");

                        Log.d(TAG, "rahamActive: " + rahamActive);

                        rahamActive=!rahamActive;
